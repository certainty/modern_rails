...
class Packwerk::FileProcessor
  ...
  sig { params(absolute_file: ::String).returns(::Packwerk::FileProcessor::ProcessedFile) }
...
class Packwerk::FilesForProcessing
  ...
  sig { params(absolute_file_path: ::String).returns(T::Set[::String]) }
...
Packwerk::FilesForProcessing::AbsoluteFileSet = T.type_alias { T::Set[::String] }
...
class Packwerk::ParseRun
  sig do
    params(
      absolute_file_set: T::Set[::String],
      configuration: ::Packwerk::Configuration,
      progress_formatter: ::Packwerk::Formatters::ProgressFormatter,
      offenses_formatter: ::Packwerk::OffensesFormatter
    ).void
  end
  def initialize(absolute_file_set:, configuration:, progress_formatter: T.unsafe(nil), offenses_formatter: T.unsafe(nil)); end
...
class Packwerk::Parsers::Ruby::RaiseExceptionsParser < ::Parser::Ruby31
